		...
		<SheetPortal>
			...
			<SheetPrimitive.Popup
				className={cn(
					...
					floating
						? "data-[side=left]:sm:top-4 data-[side=left]:sm:bottom-4 data-[side=left]:sm:left-4 data-[side=left]:sm:h-auto data-[side=left]:sm:rounded-lg data-[side=right]:sm:top-4 data-[side=right]:sm:right-4 data-[side=right]:sm:bottom-4 data-[side=right]:sm:h-auto data-[side=right]:sm:rounded-lg"
						: null,
					className,
				)}
				data-side={side}
